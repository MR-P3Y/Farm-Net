class AdminMediaFile {
  ...
  String get publicPath => '/api/v1/media/public/$fileKey';
  String get privatePath => '/api/v1/media/private/$fileKey';
  String get adminPrivatePath => '/api/v1/admin/media/private/$fileKey';

  factory AdminMediaFile.fromJson(Map<String, dynamic> json) {
