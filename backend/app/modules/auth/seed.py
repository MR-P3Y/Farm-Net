...
BASE_PERMISSIONS: list[PermissionSeed] = [
    ...
    PermissionSeed("products.read", "Read products", "store", "View products"),
    ...
    PermissionSeed("products.suspend", "Suspend products", "store", "Suspend products"),
    PermissionSeed("products.restore", "Restore products", "store", "Restore products"),
