...
from app.modules.subscriptions.admin_router import router as admin_subscriptions_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_ai_router, prefix=settings.api_v1_prefix)
